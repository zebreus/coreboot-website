          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                ...
                alternative. */}
                coreboot is an extended firmware platform that delivers a
                lightning fast and secure boot experience on modern computers
                and embedded systems. As an Open Source project it provides
                auditability and maximum control over technology.
              </p>
            </div>
          </div>
